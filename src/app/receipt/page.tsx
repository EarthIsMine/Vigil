        ...
        {!showResults ? (
          ...
          <div className="min-h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center px-6">
            <div className="max-w-2xl w-full text-center space-y-8 fade-up">
              <div className="flex justify-center mb-6 fade-up-d1">
              ...
              <div className="space-y-4 fade-up-d3">
                <div className="relative">
                  <input
                    type="text"
                ...
                <button
                  ...
                  className="w-full py-4 bg-vigil-accent hover:bg-vigil-accent/90 rounded-xl font-display font-semibold text-white glow-blue-btn transition"
                >
                  ANALYZE
                </button>
              </div>

              <div className="flex items-center justify-center gap-6 pt-8 fade-up-d4">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-vigil-card-dark/50 border border-vigil-border-dark rounded-lg">
                  ...
                  <span className="text-xs font-mono text-vigil-muted">Base Sepolia</span>
                </div>
              </div>
            </div>
          </div>
