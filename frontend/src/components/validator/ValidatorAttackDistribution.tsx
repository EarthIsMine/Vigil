...
export default function ValidatorAttackDistribution({ attacksByType, attacksTotal, pools }: Props) {
  const entries = Object.entries(attacksByType).sort((a, b) => b[1] - a[1]);
    ...
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-14 fade-up fade-up-d4">
      <div>
        ...
        <DonutChart
          ...
          centerText={attacksTotal.toLocaleString()}
          centerSubText="total"
        />
      </div>
